...
public class AdminService {
	...
	{
	 String output = adminObj.createEmployees(name, nic, email,pnumber, pwd,status);
	return output;
	}
	...
	//Read the values from the JSON object
	 String eid = adminObject.get("id").getAsString();
	 ...
	 String pnumber = adminObject.get("pnumber").getAsString();
	 String epassword = adminObject.get("password").getAsString();
	 String estatus = adminObject.get("status").getAsString();
	
	 String output = adminObj.updateEmployees(eid,ename, enic, eemail,pnumber, epassword, estatus);
	return output;
	}
	...
	//Convert the input string to an XML document
	 ...
	 String output = adminObj.deleteDoctors(id);
	return output;
	}
